        ...
        <div className="h-screen">
            ...
            <div className="w-full mx-auto mt-5 px-20 font-['Archivo'] text-center ">
                <div className="grid grid-cols-2 gap-y-1 gap-x-2 items-center">
                    <div className=" rounded-md font-['BreeSerif'] text-xl  bg-slate-100 ">Project : To Do</div>
                    ...
                    <div className="rounded-md font-['BreeSerif'] text-xl  bg-slate-100 ">Project : Heroes</div>
                    <div className="grid grid-cols-1 bg-white">
                        <div>
                            <p>
                    ...
                    <div className="rounded-md font-['BreeSerif'] text-xl  bg-slate-100 ">Project : Weather</div>
                    <div className="grid grid-cols-1 bg-white">
                        <div>
                            <p>
                    ...
                    <div className="rounded-md font-['BreeSerif'] text-xl  bg-slate-100 ">Project : Landing Page</div>
                    <div className="grid grid-cols-1 bg-white">
                        <div>
                            <p>
